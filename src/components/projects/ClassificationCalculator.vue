                    ...
                    <v-col cols="12" sm="12" md="7">
                        ...
                        <v-row>
                            ...
                            <v-col >
                                ...
                                cover
                                src="@/assets/images/calculator/calc-1.jpg"
                                ></v-img>
                            </v-col>
                        </v-row>
                        <v-row>
